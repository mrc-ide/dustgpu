...
template <typename T>
H T odin_sum1(const T * x, size_t from, size_t to);
template <typename real_t, typename int_t>
H real_t odin_sum2(const real_t * x, int_t from_i, int_t to_i, int_t from_j, int_t to_j, int_t dim_x_1);

// Device sum templates
template <typename T>
D T odin_sum1(const dust::interleaved<T> x, size_t from, size_t to);
template <typename real_t, typename int_t>
D real_t odin_sum2(const dust::interleaved<real_t> x, int_t from_i, int_t to_i, int_t from_j, int_t to_j, int_t dim_x_1);
...
public:
  ...
  H void update(size_t step, const real_t * state, dust::rng_state_t<real_t> rng_state, real_t * state_next) {
...
template <typename T>
D T odin_sum1(const T * x, size_t from, size_t to) {
  T tot = 0.0;
...
template <>
D void update_device<sir>(size_t step, const dust::interleaved<sir::real_t> state,
