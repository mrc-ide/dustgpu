...
sir <- R6::R6Class(
  ...
  public = list(
    ...
    size_internal_int = function() {
      dust_sir_size_internal_int(private$ptr_)
    },

    size_internal_real = function() {
      dust_sir_size_internal_real(private$ptr_)
    },

    internal_int = function() {
      dust_sir_internal_int(private$ptr_)
    },
