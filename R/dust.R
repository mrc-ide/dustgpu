sirs <- R6::R6Class(
  ...
  private = list(
    ...
    has_default = FALSE, default_value = NULL, rank = 2, min = -Inf,
    max = Inf, integer = FALSE), N_age = list(has_default = FALSE,
    default_value = NULL, rank = 0, min = -Inf, max = Inf, integer = FALSE),
    alpha = list(has_default = TRUE, default_value = 0.1, rank = 0,
        min = -Inf, max = Inf, integer = FALSE), beta = list(
        has_default = TRUE, default_value = 0.2, rank = 0, min = -Inf,
        max = Inf, integer = FALSE), dt = list(has_default = TRUE,
        default_value = 1L, rank = 0, min = -Inf, max = Inf,
        integer = FALSE), gamma = list(has_default = TRUE, default_value = 0.1,
        rank = 0, min = -Inf, max = Inf, integer = FALSE), S_ini = list(
        has_default = TRUE, default_value = 1000L, rank = 0,
  ...
  public = list(
    ...
    ##' the retuened array is one less. For a scalar `step_end` you would
    ...
    rng_state = function(first_only = FALSE) {
      dust_sirs_rng_state(private$ptr_, first_only)
    },
    ...
    ##' as `sirs$public_methods$has_openmp()`
    has_openmp = function() {
    ...
    ##' as `sirs$public_methods$has_compare()`
